...
namespace DataStaxStyle
{
    ...
    /// of.</remarks>
    [PresentationStyleExport("DataStaxStyle", "DataStaxStyle", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "DataStaxStyle custom presentation style")]
    public sealed class DataStaxStylePresentationStyle : PresentationStyleSettings
    {
        /// <inheritdoc />
        ...
        /// Constructor
        /// </summary>
        public DataStaxStylePresentationStyle()
        {
