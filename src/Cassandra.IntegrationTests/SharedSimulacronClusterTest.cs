...
namespace Cassandra.IntegrationTests
{
    ...
    /// </summary>
    [TestFixture]
    public class SharedSimulacronClusterTest
    {
        ...
        /// </summary>
        protected int AmountOfNodes => int.Parse(Options.Nodes);
        ...
        protected SharedSimulacronClusterTest(SimulacronOptions options, bool createSession = true)
        {
        ...
        protected SharedSimulacronClusterTest(int amountOfNodes = 1, bool createSession = true) :
            this(new SimulacronOptions() { Nodes = amountOfNodes.ToString() }, createSession)
        {
        }

        protected virtual SimulacronCluster CreateNew(SimulacronOptions options)
        {
            return SimulacronCluster.CreateNew(options);
        }
        ...
        public virtual void OneTimeSetUp()
        {
            ...
            Trace.WriteLine("Reusing simulacron instance");
