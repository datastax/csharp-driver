...
namespace Cassandra.IntegrationTests.Core
{
    ...
    public class MetadataTests : TestGlobals
    {
        ...
        {
            ITestCluster testCluster = TestClusterManager.GetTestCluster(DefaultNodeCount);
            CheckMetadata(testCluster, TestUtils.GetUniqueKeyspaceName());
        }
        ...
        public void CheckTableMetadataWithOptions()
        {
            ITestCluster testCluster = TestClusterManager.GetTestCluster(DefaultNodeCount);
            string keyspaceName = TestUtils.GetUniqueKeyspaceName();
            CheckMetadata(testCluster, keyspaceName,
        ...
        public void CheckKeyspaceMetadata()
        {
            ...
            for (var i = 0; i < 10; i++)
            {
                CheckPureMetadata(testCluster.Cluster, session, keyspaceName);
            }
        ...
        [Test, TestCassandraVersion(2, 1), Category("short")]
        ...
        private void CheckPureMetadata(Cluster cluster, ISession session, string keyspaceName, TableOptions tableOptions = null)
        {
        ...
        private void CheckMetadata(ITestCluster testCluster, string keyspaceName, TableOptions tableOptions = null)
        {
            var cluster = testCluster.Cluster;
            var session = testCluster.Session;
            ...
            CheckPureMetadata(cluster, session, keyspaceName, tableOptions);
        }
