...
namespace Cassandra.IntegrationTests.Core
{
    ...
    public class SchemaMetadataTests : SharedClusterTest
    {
        ...
        {
            var cluster = GetNewCluster(builder => builder.WithMetadataSyncOptions(new MetadataSyncOptions { MetadataSyncEnabled = metadataSync }));
            // Basic status check
        ...
        public void GetMaterializedView_Should_Refresh_View_Metadata_Via_Events(bool metadataSync)
        {
            ...
            var cluster = GetNewCluster(builder => builder.WithMetadataSyncOptions(new MetadataSyncOptions { MetadataSyncEnabled = metadataSync }));
            var cluster2 = GetNewCluster(builder => builder.WithMetadataSyncOptions(new MetadataSyncOptions { MetadataSyncEnabled = metadataSync }));
            var session = cluster.Connect();
        ...
        public void MaterializedView_Base_Table_Column_Addition(bool metadataSync)
        {
            ...
            var colName = $"fouls{session.GetHashCode()}";
