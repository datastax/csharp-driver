...
namespace Cassandra
{
    ...
    /// Also any serialized value that is an empty byte array (like empty strings) will also technically not be encrypted even though an IV will be stored next to it.
    /// </para>
    /// </remarks>
    public class AesColumnEncryptionPolicy : BaseColumnEncryptionPolicy<AesColumnEncryptionPolicy.AesKeyAndIV>
    {
        ...
        /// <summary>
        /// <para>
        /// This type contains a key and IV to be used in AES encryption.
        ...
        /// E.g. let's say there is an "INSERT INTO table (X, Y) VALUES (?, ?)" and "SELECT * FROM table where X = ?" statements where X is an encrypted column.
        ...
        public class AesKeyAndIV
        {
            ...
            /// <summary>
            /// Constructor that doesn't allow you to provide the IV. If you need to provide a static IV then use <see cref="AesKeyAndIV(byte[],byte[])"/>.
            /// For information about whether you should provide an IV or not please look at the documentation on this class <see cref="AesKeyAndIV"/>.
            /// </summary>
            ...
            /// <summary>
            /// Constructor that allows you to provide the IV. If you don't need to provide a static IV then use <see cref="AesKeyAndIV(byte[])"/>.
            /// For information about whether you should provide an IV or not please look at the documentation on this class <see cref="AesKeyAndIV"/>.
            /// </summary>
