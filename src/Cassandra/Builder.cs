...
namespace Cassandra
{
    ...
    public class Builder : IInitializer
    {
        ...
        /// </para>
        /// <para>
        /// In case you disable Metadata synchronization, please ensure you invoke <see cref="IMetadata.RefreshSchemaAsync"/> (accessible via <see cref="ICluster.Metadata"/>) in order to keep the token metadata up to date
        ...
        /// if you keep the token metadata up to date using the <see cref="IMetadata.RefreshSchemaAsync"/> method (accessible via <see cref="ICluster.Metadata"/>).
