...
namespace Cassandra.Search
{
    ...
    public struct DateRangeBound : IEquatable<DateRangeBound>
    {
        ...
        public override string ToString()
        {
            ...
            return string.Format(FormatByPrecision[(int) Precision],
        ...
        {
            if (boundaryString == UnboundedString)
            {
                return Unbounded;
            }
            return ParseBuilder(boundaryString).Build();
        }
