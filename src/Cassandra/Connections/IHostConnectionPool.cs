...
namespace Cassandra.Connections
{
    internal interface IHostConnectionPool : IDisposable
    {
        ...
        IConnection BorrowExistingConnection(RoutingKey routingKey, int shardID = -1);
        ...
        Task<IConnection> GetConnectionFromHostAsync(
            IDictionary<IPEndPoint, Exception> triedHosts, Func<string> getKeyspaceFunc, RoutingKey routingKey, int shardID);
