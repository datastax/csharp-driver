...
namespace Cassandra.Requests
{
    ...
    {
        void TrySetResult(RowSet result, RequestTrackingInfo requestTrackingInfo);

        void TrySetException(Exception exception, RequestTrackingInfo requestTrackingInfo);
