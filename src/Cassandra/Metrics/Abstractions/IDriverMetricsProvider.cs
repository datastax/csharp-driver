...
namespace Cassandra.Metrics.Abstractions
{
    ...
    {
        /// <summary>
        /// Creates a timer metric. <paramref name="bucket"/> will contain the prefix configured with <see cref="DriverMetricsOptions.SetPathPrefix"/>,
        ...
        /// <summary>
        /// Creates a meter metric. <paramref name="bucket"/> will contain the prefix configured with <see cref="DriverMetricsOptions.SetPathPrefix"/>,
        /// session name and node's address. Node's address will only be in the bucket name when <paramref name="metric"/> is a <see cref="NodeMetric"/>.
        /// Implementations can call <see cref="object.Equals(object)"/> to test if <paramref name="metric"/> is a particular <see cref="NodeMetric"/> or <see cref="SessionMetric"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates a counter metric. <paramref name="bucket"/> will contain the prefix configured with <see cref="DriverMetricsOptions.SetPathPrefix"/>,
        /// session name and node's address. Node's address will only be in the bucket name when <paramref name="metric"/> is a <see cref="NodeMetric"/>.
        /// Implementations can call <see cref="object.Equals(object)"/> to test if <paramref name="metric"/> is a particular <see cref="NodeMetric"/> or <see cref="SessionMetric"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates a gauge metric. <paramref name="bucket"/> will contain the prefix configured with <see cref="DriverMetricsOptions.SetPathPrefix"/>,
        /// session name and node's address. Node's address will only be in the bucket name when <paramref name="metric"/> is a <see cref="NodeMetric"/>.
        /// Implementations can call <see cref="object.Equals(object)"/> to test if <paramref name="metric"/> is a particular <see cref="NodeMetric"/> or <see cref="SessionMetric"/>.
        /// </summary>
