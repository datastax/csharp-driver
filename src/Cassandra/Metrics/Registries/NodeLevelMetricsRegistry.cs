...
{
    internal class NodeLevelMetricsRegistry
    {
        public static readonly NodeLevelMetricsRegistry EmptyInstance = new NodeLevelMetricsRegistry(NullDriverMetricsProvider.Instance);
